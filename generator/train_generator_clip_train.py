...
def parse_args():
    ...
    parser.add_argument(
        "--learning_rate",
        type=float,
        default=1e-5,                  # Note learning rate from 1e-4 -> 1e-5
...
def main():
    ...
    lr_scheduler_clip = get_scheduler(
        args.lr_scheduler,
    ...
    clip_model, optimizer_clip,lr_scheduler_clip = accelerator.prepare(clip_model, optimizer_clip, lr_scheduler_clip)
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if accelerator.sync_gradients:
                    ...
                    if global_step % args.checkpointing_steps == 0:
                        logging.info("Epoch : {} ; Step : {} ; Save checkpoint to {}".format(epoch, global_step, args.output_dir))
                        if accelerator.is_main_process:
