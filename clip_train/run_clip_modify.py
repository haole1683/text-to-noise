...
def main():
    ...
    class MyTrainer(Trainer):
        ...
        def _inner_training_loop(
            ...
            self.create_optimizer_and_scheduler(num_training_steps=1500)
            ...
            for epoch in range(0, 10):
                ...
                for step, inputs in enumerate(epoch_iterator):
                    with self.accelerator.accumulate(model):
                        tr_loss_step = model(**inputs).loss
            ...
            return TrainOutput(self.state.global_step, tr_loss_step, metrics)
    ...
    if training_args.do_train:
        ...
        optimizer = optimizer_cls(optimizer_grouped_parameters, lr=lr, **adam_kwargs)
